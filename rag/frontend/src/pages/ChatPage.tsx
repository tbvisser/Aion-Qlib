...
import { ComposerMenu, ActiveModeChip, type ComposerMode } from '@/components/chat/ComposerMenu'
import { AttachmentPreviewTray } from '@/components/chat/AttachmentPreviewTray'
import { ChatFileDropOverlay } from '@/components/chat/ChatFileDropOverlay'
import { PlanPanel } from '@/components/deep/PlanPanel'
import { WorkspacePanel } from '@/components/deep/WorkspacePanel'
import { SidecarPreview } from '@/components/deep/SidecarPreview'
import { CitationSourcePanel } from '@/components/citations/CitationSourcePanel'
import { AppSidebar } from '@/components/layout/AppSidebar'
import { MobileTopBar } from '@/components/layout/MobileTopBar'
import { Button } from '@/components/ui/button'
import { Textarea } from '@/components/ui/textarea'
import { createThread, getTodos, getWorkspaceFiles, fetchApi } from '@/lib/api'
import { getPastedImageFile } from '@/lib/clipboardFiles'
...
import type { TodoItem, AgentStatus, WorkspaceFile, HarnessRun, AnswerCitation, CitationVerificationMode } from '@/types'
        ...
        {sidecarMode !== 'hidden' && (
          <div
            ...
            className={`hidden lg:flex flex-col shrink-0 border-l border-border/50 bg-surface-1 transition-[width] duration-200 ease-out ${
              ...
              sidecarMode === 'preview' || sidecarMode === 'citation' ? 'w-[50vw]' :
              'w-[300px]'
            }`}
          >
