...
import { DocumentStructureNav } from '@/components/documents/DocumentStructureNav'
import { DocumentTextView } from '@/components/documents/DocumentTextView'
...
export function DocsSidecar({ document: doc, onClose, onDeleted }: DocsSidecarProps) {
  ...
  return (
    <div
      ...
      className={`absolute right-0 top-0 z-30 flex h-full w-full flex-col border-l border-border/50 bg-card shadow-xl transition-[width] duration-200 ${isExpanded ? 'md:w-[72vw]' : 'md:w-[50vw]'}`}
    >
