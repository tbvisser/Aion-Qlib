 ...
 */
/** The same mapping for text, so list rows never restate the colour rules. */
export function statusTextClass(status: RunStatus): string {
  if (status === 'succeeded' || status === 'running') return 'text-primary'
