...
import { DocumentUpload } from '@/features/rag/components/documents/DocumentUpload'
import { DocumentList } from '@/features/rag/components/documents/DocumentList'
import { DocsSidecar } from '@/features/rag/components/documents/DocsSidecar'
import { FolderBreadcrumbs } from '@/features/rag/components/documents/FolderBreadcrumbs'
import { FolderTree } from '@/features/rag/components/folders/FolderTree'
import { bulkDeleteDocuments, bulkMoveDocuments, deleteDocument, listFolders, listDocuments, retryDocument, searchDocuments } from '@/features/rag/lib/api'
import { useDebouncedValue } from '@/features/rag/hooks/useDebouncedValue'
import { isFileDrag } from '@/features/rag/hooks/useFileDrop'
...
export function DocumentsPage() {
  ...
  // renders the shell beside <main> and this fills <main>. So the folder tree
